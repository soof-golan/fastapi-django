...
var _sliceInstanceProperty = require("@babel/runtime-corejs3/config-js-stable/instance/slice");

var _Array$from = require("@babel/runtime-corejs3/config-js-stable/array/from");

var _Symbol = require("@babel/runtime-corejs3/config-js-stable/symbol");

var _getIteratorMethod = require("@babel/runtime-corejs3/config-js/get-iterator-method");

var _Array$isArray = require("@babel/runtime-corejs3/config-js-stable/array/is-array");

var _Object$defineProperty = require("@babel/runtime-corejs3/config-js-stable/object/define-property");
...
var _forEach = _interopRequireDefault(require("@babel/runtime-corejs3/config-js-stable/instance/for-each"));

var _concat = _interopRequireDefault(require("@babel/runtime-corejs3/config-js-stable/instance/concat"));

var _indexOf = _interopRequireDefault(require("@babel/runtime-corejs3/config-js-stable/instance/index-of"));
...
var _sliceInstanceProperty2 = require("@babel/runtime-corejs3/config-js-stable/instance/slice");
...
var _flags = _interopRequireDefault(require("@babel/runtime-corejs3/config-js-stable/instance/flags"));

var _sort = _interopRequireDefault(require("@babel/runtime-corejs3/config-js-stable/instance/sort"));

var _slice = _interopRequireDefault(require("@babel/runtime-corejs3/config-js-stable/instance/slice"));

var _parseInt2 = _interopRequireDefault(require("@babel/runtime-corejs3/config-js-stable/parse-int"));

var _indexOf = _interopRequireDefault(require("@babel/runtime-corejs3/config-js-stable/instance/index-of"));

var _forEach = _interopRequireDefault(require("@babel/runtime-corejs3/config-js-stable/instance/for-each"));

var _create = _interopRequireDefault(require("@babel/runtime-corejs3/config-js-stable/object/create"));
...
function hasNativeFlag(flag) {
  ...
  try {
    ...
    new RegExp('', flag); // Work around a broken/incomplete IE11 polyfill for sticky introduced in config-js 3.6.0
...
var _Array$isArray = require("@babel/runtime-corejs3/config-js/array/is-array");
...
var _Symbol = require("@babel/runtime-corejs3/config-js/symbol");
...
var _sliceInstanceProperty = require("@babel/runtime-corejs3/config-js/instance/slice");

var _Array$from = require("@babel/runtime-corejs3/config-js/array/from");
...
'use strict';
var IteratorPrototype = require('../internals/iterators-config').IteratorPrototype;
...
var wellKnownSymbol = require('../internals/well-known-symbol');
var Iterators = require('../internals/iterators');
var IteratorsCore = require('../internals/iterators-config');
...
// this helper broken in `config-js@3.4.1-3.4.4`, so we can't use `shared` helper
